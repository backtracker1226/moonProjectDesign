					...
					<div class="form-group">
						...
						<div class="col-sm-11">
							<input type="text" name="title" class="form-control"
								id="inputTitle" value="${boardVO.title}" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
						...
						<textarea  class="textarea" disabled="disabled"
								style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">${boardVO.reviewcon}</textarea>
